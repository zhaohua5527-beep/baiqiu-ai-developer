import { type CopyTextButton, type InlineKeyboardButton, type KeyboardButton, type KeyboardButtonPollType, type KeyboardButtonRequestChat, type KeyboardButtonRequestManagedBot, type KeyboardButtonRequestUsers, type LoginUrl, type SwitchInlineQueryChosenChat, type WebAppInfo } from "../types.js";
...
export declare class Keyboard {
     ...
     * @param options Options object for further requirements
     */
    requestManagedBot(text: string | KeyboardButton.CommonButton, requestId: number, options?: Omit<KeyboardButtonRequestManagedBot, "request_id">): this;
    /**
     ...
     * @param options Options object for further requirements
     */
    static requestManagedBot(text: string | KeyboardButton.CommonButton, requestId: number, options?: Omit<KeyboardButtonRequestManagedBot, "request_id">): KeyboardButton.RequestManagedBotButton;
    /**
