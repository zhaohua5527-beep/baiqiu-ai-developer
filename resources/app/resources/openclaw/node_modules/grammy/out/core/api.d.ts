...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    exportChatInviteLink(chat_id: number | string, signal?: AbortSignal): Promise<string>;
    /**
     ...
     */
    approveChatJoinRequest(chat_id: number | string, user_id: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setChatPhoto(chat_id: number | string, photo: InputFile, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteChatPhoto(chat_id: number | string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setChatTitle(chat_id: number | string, title: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    unpinAllChatMessages(chat_id: number | string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getChat(chat_id: number | string, signal?: AbortSignal): Promise<import("@grammyjs/types/manage.js").ChatFullInfo>;
    /**
     ...
     */
    getChatAdministrators(chat_id: number | string, other?: Other<R, "getChatAdministrators", "chat_id">, signal?: AbortSignal): Promise<(import("@grammyjs/types/manage.js").ChatMemberOwner | import("@grammyjs/types/manage.js").ChatMemberAdministrator)[]>;
     ...
     */
    getUserPersonalChatMessages(user_id: number, limit: number, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Message[]>;
    /**
     ...
     */
    setChatStickerSet(chat_id: number | string, sticker_set_name: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setMyDescription(description: string, other?: Other<R, "setMyDescription", "description">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getMyDescription(other?: Other<R, "getMyDescription">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings.js").BotDescription>;
    /**
     ...
     */
    setMyShortDescription(short_description: string, other?: Other<R, "setMyShortDescription", "short_description">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setMyProfilePhoto(photo: InputProfilePhoto, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteMessageReactionUser(chat_id: number | string, message_id: number, user_id: number, other?: Other<R, "deleteMessageReaction", "chat_id" | "message_id" | "user_id">, signal?: AbortSignal): Promise<true>;
    /**
     * Use this method to remove a reaction from a message in a group or a supergroup chat. The bot must have the 'can_delete_messages' administrator right in the chat. Returns True on success.
     *
     * @param chat_id Unique identifier for the target chat or username of the target supergroup (in the format `@username`)
     ...
     * **Official reference:** https://core.telegram.org/bots/api#deletemessagereaction
     */
    deleteMessageReactionChat(chat_id: number | string, message_id: number, actor_chat_id: number, other?: Other<R, "deleteMessageReaction", "chat_id" | "message_id" | "actor_chat_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteAllMessageReactionsUser(chat_id: number | string, user_id: number, other?: Other<R, "deleteAllMessageReactions", "chat_id" | "message_id" | "user_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#deleteallmessagereactions
     */
    deleteAllMessageReactionsChat(chat_id: number | string, actor_chat_id: number, other?: Other<R, "deleteAllMessageReactions", "chat_id" | "message_id" | "actor_chat_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteBusinessMessages(business_connection_id: string, message_ids: number[], signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setBusinessAccountName(business_connection_id: string, first_name: string, other: Other<R, "setBusinessAccountName", "business_connection_id" | "first_name">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setBusinessAccountUsername(business_connection_id: string, username: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setBusinessAccountBio(business_connection_id: string, bio: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setBusinessAccountProfilePhoto(business_connection_id: string, photo: InputProfilePhoto, other: Other<R, "setBusinessAccountProfilePhoto", "business_connection_id" | "photo">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    removeBusinessAccountProfilePhoto(business_connection_id: string, other: Other<R, "removeBusinessAccountProfilePhoto", "business_connection_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setBusinessAccountGiftSettings(business_connection_id: string, show_gift_button: boolean, accepted_gift_types: AcceptedGiftTypes, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getBusinessAccountStarBalance(business_connection_id: string, signal?: AbortSignal): Promise<import("@grammyjs/types/payment.js").StarAmount>;
    /**
     ...
     */
    transferBusinessAccountStars(business_connection_id: string, star_count: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getBusinessAccountGifts(business_connection_id: string, other: Other<R, "getBusinessAccountGifts", "business_connection_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment.js").OwnedGifts>;
    /**
     ...
     */
    convertGiftToStars(business_connection_id: string, owned_gift_id: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    upgradeGift(business_connection_id: string, owned_gift_id: string, other: Other<R, "getBusinessAccountGifts", "business_connection_id" | "owned_gift_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    transferGift(business_connection_id: string, owned_gift_id: string, new_owner_chat_id: number, star_count: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    postStory(business_connection_id: string, content: InputStoryContent, active_period: number, other: Other<R, "postStory", "business_connection_id" | "content" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Story>;
    /**
     ...
     */
    repostStory(business_connection_id: string, from_chat_id: number, from_story_id: number, active_period: number, other: Other<R, "repostStory", "business_connection_id" | "from_chat_id" | "from_story_id" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Story>;
    /**
     ...
     */
    editStory(business_connection_id: string, story_id: number, content: InputStoryContent, other: Other<R, "editStory", "business_connection_id" | "story_id" | "content">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Story>;
    /**
     ...
     */
    deleteStory(business_connection_id: string, story_id: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getCustomEmojiStickers(custom_emoji_ids: string[], signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Sticker[]>;
    /**
     ...
     */
    createNewStickerSet(user_id: number, name: string, title: string, stickers: InputSticker[], other?: Other<R, "createNewStickerSet", "user_id" | "name" | "title" | "sticker_format" | "stickers">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    addStickerToSet(user_id: number, name: string, sticker: InputSticker, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerPositionInSet(sticker: string, position: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    replaceStickerInSet(user_id: number, name: string, old_sticker: string, sticker: InputSticker, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerEmojiList(sticker: string, emoji_list: string[], signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerKeywords(sticker: string, keywords: string[], signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerMaskPosition(sticker: string, mask_position?: MaskPosition, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerSetTitle(name: string, title: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setStickerSetThumbnail(name: string, user_id: number, thumbnail: InputFile | string | undefined, format: "static" | "animated" | "video", signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    sendGift(user_id: number, gift_id: string, other?: Other<R, "sendGift", "user_id" | "chat_id" | "gift_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    giftPremiumSubscription(user_id: number, month_count: 3 | 6 | 12, star_count: 1000 | 1500 | 2500, other?: Other<R, "giftPremiumSubscription", "user_id" | "month_count" | "star_count">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#sendgift
     */
    sendGiftToChannel(chat_id: number | string, gift_id: string, other?: Other<R, "sendGift", "user_id" | "chat_id" | "gift_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    savePreparedKeyboardButton(user_id: number, button: KeyboardButton.RequestUsersButton | KeyboardButton.RequestChatButton | KeyboardButton.RequestManagedBotButton, signal?: AbortSignal): Promise<import("@grammyjs/types/markup.js").PreparedKeyboardButton>;
    /**
     ...
     */
    sendInvoice(chat_id: number | string, title: string, description: string, payload: string, currency: string, prices: readonly LabeledPrice[], other?: Other<R, "sendInvoice", "chat_id" | "title" | "description" | "payload" | "currency" | "prices">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Message.InvoiceMessage>;
    /**
     ...
     */
    answerShippingQuery(shipping_query_id: string, ok: boolean, other?: Other<R, "answerShippingQuery", "shipping_query_id" | "ok">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    readBusinessMessage(business_connection_id: string, chat_id: number, message_id: number, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setPassportDataErrors(user_id: number, errors: readonly PassportElementError[], signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    sendGame(chat_id: number | string, game_short_name: string, other?: Other<R, "sendGame", "chat_id" | "game_short_name">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Message.GameMessage>;
    /**
     ...
     */
    setGameScore(chat_id: number, message_id: number, user_id: number, score: number, other?: Other<R, "setGameScore", "chat_id" | "message_id" | "inline_message_id" | "user_id" | "score">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
        game: import("@grammyjs/types/message.js").Game;
    })>;
    /**
     * Use this method to set the score of the specified user in a game message. On success, if the message is not an inline message, the Message is returned, otherwise True is returned. Returns an error, if the new score is not greater than the user's current score in the chat and force is False.
     *
     ...
     * **Official reference:** https://core.telegram.org/bots/api#setgamescore
     */
    setGameScoreInline(inline_message_id: string, user_id: number, score: number, other?: Other<R, "setGameScore", "chat_id" | "message_id" | "inline_message_id" | "user_id" | "score">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
        game: import("@grammyjs/types/message.js").Game;
    })>;
    /**
